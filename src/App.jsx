...
//  SHARED STYLES
// ══════════════════════════════════════
const CSS = `@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600&family=Cormorant+Garamond:wght@400;500;600&display=swap'); *{box-sizing:border-box;margin:0;padding:0} ::-webkit-scrollbar{width:3px}::-webkit-scrollbar-thumb{background:#2A2A2A;border-radius:2px} .cr:hover{background:#181818!important}.tb:hover{color:#E2DDD6!important}.btn:hover{opacity:0.8}.row:hover{background:#1A1A1E!important} input,select,textarea{font-family:inherit}input:focus,select:focus,textarea:focus{outline:none;border-color:#444!important} .tag{display:inline-flex;align-items:center;padding:3px 10px;border-radius:20px;font-size:10px;font-weight:500} .app-layout{display:flex;min-height:100vh} .sidebar{width:240px;flex-shrink:0;transition:transform 0.3s ease} .main-content{flex:1;overflow-y:auto;min-width:0;display:flex;flex-direction:column} .grid-3{display:grid;grid-template-columns:repeat(3,1fr);gap:12px} .grid-2{display:grid;grid-template-columns:repeat(2,1fr);gap:14px} .grid-split{display:grid;grid-template-columns:1fr 2fr;gap:16px} .grid-budget{display:grid;grid-template-columns:2fr 1fr;gap:16px} .tabs-row{display:flex;overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:none} .tabs-row::-webkit-scrollbar{display:none} .page-pad{padding:24px 32px} .header-pad{padding:18px 32px} .mob-btn{display:none;background:none;border:none;cursor:pointer;color:#C9A96E;font-size:22px;padding:4px 8px;font-family:inherit} .overlay{display:none;position:fixed;inset:0;background:rgba(0,0,0,0.6);z-index:40} @media(max-width:768px){ .app-layout{flex-direction:column} .sidebar{position:fixed;left:0;top:0;bottom:0;z-index:50;transform:translateX(-100%);width:260px} .sidebar.open{transform:translateX(0)!important} .overlay.open{display:block} .mob-btn{display:block} .main-content{width:100%} .grid-3{grid-template-columns:1fr} .grid-2{grid-template-columns:1fr} .grid-split{grid-template-columns:1fr} .grid-budget{grid-template-columns:1fr} .page-pad{padding:14px 16px} .header-pad{padding:12px 16px} .hide-mob{display:none!important} .show-mob{display:block!important} .show-mob-flex{display:flex!important} .modal-box{width:92vw!important;max-width:420px!important} }`;
