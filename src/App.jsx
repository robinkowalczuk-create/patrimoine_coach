        ...
        <div>
          ...
          <div style={{ background: epargne >= 0 ? "#1A2F1F" : "#2F1010", border: `1px solid ${epargne>=0?"#5EBF7A30":"#E07A7A30"}`, borderRadius: 12, padding: "16px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
            <div>
              ...
              <div style={{ fontSize: 11, color: theme.text3 }}>Revenus ({fmt(totalRevenus)}) − Dépenses ({fmt(totalDepenses)})</div>
            </div>
          ...
          {virements.length > 0 && (
            <div style={{ background: theme.purpleBg, border: "1px solid #8B7BAB30", borderRadius: 12, padding: "14px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 8 }}>
              <div>
          ...
          {totalRevenus > 0 ? (
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={chartData} barSize={28}>
                ...
                <Tooltip formatter={v=>fmt(v)} contentStyle={{ background:theme.bg4,border:"none",borderRadius:6,fontSize:11,color:theme.text }} />
            ...
            {[
              ...
              <div key={i} style={{ display:"flex",justifyContent:"space-between",alignItems:"center",padding:"6px 0",borderBottom:`1px solid ${theme.border}` }}>
                <div style={{ display:"flex",alignItems:"center",gap:6 }}>
                  ...
                  <span style={{ fontSize:11,color:theme.text3 }}>{r.label}</span>
                </div>
        ...
        <div>
          ...
          {(data?.objectif_global || data?.description) && (
            <div style={{ background: theme.bg2, border: `1px solid ${theme.border}`, borderRadius: 12, padding: 20 }}>
              ...
              {data?.description && <><div style={{ fontSize: 9, color: theme.text5, textTransform: "uppercase", letterSpacing: "0.15em", marginBottom: 6 }}>Notes</div><div style={{ fontSize: 13, color: theme.text5, lineHeight: 1.6 }}>{data.description}</div></>}
            </div>
          )}
  ...
  return (
    <div>
      ...
      <div className="grid-3" style={{ marginBottom: 16 }}>
        <div style={{ background: theme.greenBg, border: "1px solid #5EBF7A30", borderRadius: 10, padding: "14px 16px" }}>
        ...
        {entreprises.length === 0 ? (
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                ...
                {supports.map(support => {
                  ...
                  return (
                    <React.Fragment key={support}>
                      {/* Support header row */}
                      <tr style={{ background: theme.inputBg, borderBottom: `1px solid ${theme.border}`, borderTop: `2px solid ${theme.border2}` }}>
              ...
              <tfoot>
                <tr style={{ borderTop: `2px solid ${theme.border2}` }}>
...
function SimulateurSection({ patrimoineActuel }) {
  ...
  return (
    <div>
      ...
      <div className="grid-3" style={{ marginBottom: 20 }}>
        {[
          { label: `Scénario pessimiste (${params.taux_pessimiste}%)`, val: fmtK(finalPessimiste), color: "#E07A7A", bg: theme.redBg },
          { label: `Scénario réaliste (${params.taux_realiste}%)`, val: fmtK(finalRealiste), color: "#C9A96E", bg: theme.bg4 },
          { label: `Scénario optimiste (${params.taux_optimiste}%)`, val: fmtK(finalOptimiste), color: "#5EBF7A", bg: theme.greenBg },
        ].map((k, i) => (
      ...
      {afficherSupp && (
        <div style={{ background: theme.purpleBg, border: "1px solid #8B7BAB30", borderRadius: 10, padding: "14px 20px", marginBottom: 20, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
        ...
        <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginTop: 12, justifyContent: "center" }}>
          {[
            ...
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <span style={{ fontSize: 10, color: theme.text3 }}>{l.label}</span>
            </div>
          ))}
        </div>
      </div>
...
function ImmoLocatifSection() {
  ...
  return (
    <div>
      ...
      <div className="grid-3" style={{ marginBottom: 16 }}>
        {[
          { label: "Rendement brut", val: fmtPct(rendement_brut), color: "#E07A7A", bg: theme.redBg },
          { label: "Rendement net de charges", val: fmtPct(rendement_net), color: "#C9A96E", bg: theme.bg4 },
          { label: "Rendement net-net (après impôts)", val: fmtPct(rendement_net_net), color: "#5EBF7A", bg: theme.greenBg },
        ].map((k, i) => (
          <div key={i} style={{ background: k.bg, border: `1px solid ${k.color}25`, borderRadius: 10, padding: "14px 16px" }}>
            <div style={{ fontSize: 9, color: k.color, textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: 5 }}>{k.label}</div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
            ...
            <tbody>
              {simData.map((r, i) => {
                ...
                return (
                  <tr key={i} style={{ borderBottom: `1px solid ${theme.border}`, background: i%2===0?"transparent":"#0A0A0C" }}>
...
function ImpotsSection({ clientId }) {
  ...
  return (
    <div>
      ...
      <div className="grid-3" style={{ marginBottom: 20 }}>
        {[
          { label: "Impôt estimé", val: fmt(impot_net), color: "#E07A7A", bg: theme.redBg },
          { label: "Taux prélèvement à la source", val: fmtPct(taux_source), color: "#7C9B8A", bg: theme.tealBg },
          { label: "Tranche marginale (TMI)", val: fmtPct(tmi), color: "#8B7BAB", bg: theme.purpleBg },
        ].map((k,i) => (
          <div key={i} style={{ background: k.bg, border: `1px solid ${k.color}25`, borderRadius: 10, padding: "14px 16px" }}>
            <div style={{ fontSize: 9, color: k.color, textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: 5 }}>{k.label}</div>
            <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 28, color: k.color }}>{k.val}</div>
        ...
        <div>
          {timeline.length < 2
            ...
            : <div style={{ background: theme.bg2, border: `1px solid ${theme.border}`, borderRadius: 12, padding: 24, marginBottom: 16 }}>
                <div style={{ fontSize: 9, color: theme.text5, textTransform: "uppercase", letterSpacing: "0.15em", marginBottom: 18 }}>Patrimoine total</div>
...
function RevenusSection({ db, clientId, color, fmt }) {
  ...
  return (
    <div>
      ...
      <div className="grid-3" style={{ marginBottom: 20 }}>
        {[
          { label: `Revenus ${CURRENT_YEAR}`, val: fmt(totalParAnnee[CURRENT_YEAR] || 0), color: color || "#C9A96E", bg: theme.bg4 },
    ...
    <div>
      ...
      <div className="grid-3" style={{ marginBottom: 20 }}>
        {[
          ...
          { label: "Dettes immobilières", val: fmt(totalDette), color: "#E07A7A", bg: theme.redBg },
          { label: "Patrimoine immobilier net", val: fmt(patrimoineNet), color: "#5EBF7A", bg: theme.greenBg },
        ].map((k, i) => (
        ...
        {notes.map((n) => {
          ...
          return (
            <div key={n.id} style={{ background: theme.bg2, border: `1px solid ${theme.border}`, borderLeft: `3px solid ${noteColor}50`, borderRadius: "0 10px 10px 0", padding: "14px 18px" }}>
              ...
              <div style={{ fontSize: 13, color: theme.text5, lineHeight: 1.6 }}>{n.texte}</div>
            </div>
          );
        })}
      </div>
    ...
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {cat.items.map((item, i) => {
          ...
          return (
            <div key={i} style={{ background: theme.bg2, border: `1px solid ${isOpen ? cat.color + "40" : "#1A1A1E"}`, borderRadius: 12, overflow: "hidden", transition: "border-color 0.2s" }}>
              {/* Header */}
                ...
                <div style={{ padding: "0 20px 20px" }}>
                      ...
                      <tbody>
                        {item.details.map((d, di) => (
                          <tr key={di} style={{ borderBottom: `1px solid ${theme.border}` }}>
                            <td style={{ padding: "8px 16px 8px 0", fontSize: 11, color: theme.text3, width: "35%", verticalAlign: "top" }}>{d.label}</td>
                  ...
                  {item.note && (
                    <div style={{ background: `${cat.color}10`, border: `1px solid ${cat.color}25`, borderRadius: 8, padding: "10px 14px", display: "flex", gap: 10 }}>
                      ...
                      <span style={{ fontSize: 12, color: theme.text5, lineHeight: 1.6 }}>{item.note}</span>
                    </div>
                  )}
                </div>
              )}
                ...
                <div key={i} style={{ position: "absolute", left, top, transform: "translate(-50%, -50%)" }}>
                  <div style={{ position: "relative" }}>
                    ...
                    <div style={{
                      ...
                      fontSize: 9, color: theme.text5, whiteSpace: "nowrap",
      ...
      <div style={{ marginTop: 24, padding: "14px 20px", background: theme.bg2, border: `1px solid ${theme.border}`, borderRadius: 12 }}>
        ...
        <div style={{ fontSize: 11, color: theme.text4, lineHeight: 1.8 }}>
          • <span style={{ color: theme.text3 }}>Banque de France</span> -- banque-france.fr (taux réglementés)<br/>
          • <span style={{ color: theme.text3 }}>AMF (Autorité des Marchés Financiers)</span> -- amf-france.org (réglementation, éducation financière)<br/>
          • <span style={{ color: theme.text3 }}>Direction Générale des Finances Publiques</span> -- impots.gouv.fr (fiscalité de l'épargne)<br/>
          • <span style={{ color: theme.text3 }}>MoneyVox</span> -- moneyvox.fr (comparatifs produits épargne)<br/>
          • <span style={{ color: theme.text3 }}>JustETF</span> -- justetf.com (données ETF)<br/>
          • <span style={{ color: theme.text3 }}>IEIF</span> -- ieif.fr (données immobilier et SCPI)<br/>
          • <span style={{ color: theme.text3 }}>Vanguard Research</span> -- "Dollar Cost Averaging Just Means Taking Risk Later" (2012)
        </div>
        <div style={{ fontSize: 10, color: theme.text5, marginTop: 10, fontStyle: "italic" }}>
                        ...
                        return(
                          <div key={obj.id} style={{background:theme.bg2,border:`1px solid ${theme.border}`,borderRadius:12,overflow:"hidden"}}>
                            <div style={{padding:"18px 20px",borderBottom:`1px solid ${theme.border}`}}>
                              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}}>
                                <div><div style={{fontSize:15,fontWeight:500,marginBottom:3}}>{obj.nom}</div>{obj.description&&<div style={{fontSize:11,color:theme.text3}}>{obj.description}</div>}</div>
                                <div style={{display:"flex",alignItems:"center",gap:8}}>
    ...
    <div style={{minHeight:"100vh",background:theme.bg,fontFamily:"'DM Sans',sans-serif",color:theme.text}}>
      ...
      <div className="header-pad" style={{borderBottom:`1px solid ${theme.border}`,display:"flex",alignItems:"center",justifyContent:"space-between",background:theme.bg2}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <button onClick={onLogout} style={{padding:"6px 14px",background:theme.inputBg,border:`1px solid ${theme.border}`,borderRadius:8,cursor:"pointer",color:theme.text3,fontSize:11,fontFamily:"inherit"}} className="hide-mob">Déconnexion</button>
          <button onClick={onLogout} style={{padding:"6px 10px",background:theme.inputBg,border:`1px solid ${theme.border}`,borderRadius:8,cursor:"pointer",color:theme.text3,fontSize:11,fontFamily:"inherit",display:"none"}} className="show-mob">↩</button>
        </div>
      </div>
